...
import { AiOutlineBorderlessTable, AiFillClockCircle } from "react-icons/ai";
      ...
      <Box sx={style}>
        <Box
          ...
          sx={{
            ...
            paddingBottom: "20px",
            paddingTop: "20px",
            bgcolor: selectedTable.available ? "green" : "red",
        ...
        >
          ...
          >
            ...
            <Typography
              ...
              sx={{ marginLeft: "10px" }}
            >
              Plugs available: {selectedTable.plugs}
            </Typography>
          </Box>
          <Box
            display="flex"
          ...
          >
            ...
            <Typography
              ...
              sx={{ marginLeft: "10px" }}
            >
              Seats available: {selectedTable.seats}
            </Typography>
          </Box>
